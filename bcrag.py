"""
bcrag — single CLI: index corpora into SQLite, search with BCE embed + rerank.
...
from bcrag_registry import IndexRegistry, resolve_db_path

ROOT = Path(__file__).resolve().parent
DEFAULT_DB = ROOT / "index.sqlite"
...
def _run_index(args: argparse.Namespace) -> int:
    from bcrag_rag import index_workdir
...
def main() -> int:
    ...
    if args.cmd == "serve":
        ...
        from bcrag_server import run_server

        return run_server(host=args.host, port=args.port, repo_root=ROOT)
